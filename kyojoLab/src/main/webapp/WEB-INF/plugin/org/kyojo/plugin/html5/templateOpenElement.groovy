...
class TemplateOpenElement extends TemplateElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<TemplateOpenElement> {
	}
