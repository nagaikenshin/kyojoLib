...
class TextAreaOpenElement extends TextAreaElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<TextAreaOpenElement> {
	}
