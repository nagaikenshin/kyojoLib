...
class ProgressOpenElement extends ProgressElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<ProgressOpenElement> {
	}
