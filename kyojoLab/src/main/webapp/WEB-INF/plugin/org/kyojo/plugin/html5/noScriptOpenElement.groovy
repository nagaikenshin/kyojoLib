...
class NoScriptOpenElement extends NoScriptElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<NoScriptOpenElement> {
	}
