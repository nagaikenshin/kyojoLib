...
class GenericXhtmlElement extends AbstractBracketsElement<XhtmlNode, XhtmlElement>
		implements XhtmlElement, BracketsElement<XhtmlNode> {
	...
	public void composeClass() {
		// defaultClass
		if(getAttrs() != null && getAttrs().containsKey("class")
				&& StringUtils.isNotBlank(getAttrs().get("class"))) {
	...
	public boolean attachXhtmlCommon(String args,
			GlobalData gbd, SessionData ssd, RequestData rqd, ResponseData rpd,
			TemplateEngine te, Set<String> valueSet) throws PluginException {
	...
	public static class Builder<T extends XhtmlElement>
			extends AbstractBracketsElement.Builder<T, XhtmlNode> {
