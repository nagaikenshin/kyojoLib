...
class FieldSetOpenElement extends FieldSetElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<FieldSetOpenElement> {
	}
