...
class FigCaptionOpenElement extends FigCaptionElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<FigCaptionOpenElement> {
	}
