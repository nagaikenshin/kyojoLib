...
class THeadElement extends AnyXhtmlElement {
	...
	THeadElement(List<TrElement> trs) {
		this.trs = trs
	}
	...
	public static class Builder extends org.kyojo.plugin.xml10.xhtml11.XhtmlElementImpl.Builder<THeadElement> {
