...
class DataListOpenElement extends DataListElement {
	...
	public static class Builder extends org.kyojo.plugin.html5.HtmlElementImpl.Builder<DataListOpenElement> {
	}
