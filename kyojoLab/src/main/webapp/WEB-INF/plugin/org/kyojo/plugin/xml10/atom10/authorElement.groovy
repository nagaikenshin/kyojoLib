...
class AuthorElement extends AnyXmlElement {
	...
	AuthorElement(NameElement name, UriElement uri, EmailElement email) {
		this.name_ = name
		this.uri = uri
		this.email = email
	}
	...
	public static class Builder extends XmlElementImpl.Builder<AuthorElement> {
