...
class SourceElement extends AnyXmlElement {
	...
	SourceElement(List<AuthorElement> authors, List<CategoryElement> categories,
	...
	@Override
	boolean hasChildren() {
		authors != null || categories != null || contributors != null || generator != null ||
			icon != null || id != null || links != null || logo != null || rights != null ||
			subtitle != null || title != null || updated != null || super.hasChildren()
	}
	...
	public static class Builder extends XmlElementImpl.Builder<SourceElement> {
