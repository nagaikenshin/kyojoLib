...
class SmallOpenElement extends SmallElement {
	...
	public static class Builder extends org.kyojo.plugin.xml10.xhtml11.XhtmlElementImpl.Builder<SmallOpenElement> {
	}
