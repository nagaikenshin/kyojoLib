...
class TFootElement extends AnyXhtmlElement {
	...
	TFootElement(List<TrElement> trs) {
		this.trs = trs
	}
	...
	public static class Builder extends org.kyojo.plugin.xml10.xhtml11.XhtmlElementImpl.Builder<TFootElement> {
