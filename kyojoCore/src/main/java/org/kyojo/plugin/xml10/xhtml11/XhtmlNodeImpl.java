...
public class XhtmlNodeImpl extends AbstractBracketsNode<XmlNode>
		implements XhtmlNode, BracketsNode<XmlNode> {
	...
	public static class Builder<T extends XhtmlNode> extends AbstractBracketsNode.Builder<T, XmlNode> {
	}
		...
		if (node instanceof XhtmlElement) {
			...
			if (element.getName() != null) {
				...
				if (name.equals("base") || name.equals("head") || name.equals("link") || name.equals("meta")
						...
						|| name.equals("embed") || name.equals("frame") || name.equals("frameset")
						|| name.equals("html") || name.equals("iframe") || name.equals("img") || name.equals("object")
						|| name.equals("picture") || name.equals("script") || name.equals("source")
						|| name.equals("video")) {
					element.setName("div");
				}
			}
